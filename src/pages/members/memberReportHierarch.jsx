...
import { getMemberReportHierarchy } from '../../service/customers/customersService';
...
function MemberReportHierarch({ open, handleClose, contactId }) {
  ...
  useEffect(() => {
    const handleGetData = async () => {
      ...
      try {
        ...
        const res = await getMemberReportHierarchy(contactId);
...
export default MemberReportHierarch;