...
export const opportunitiesDocumentsURL = baseURL + '/opportunitiesDocuments'
...
export const todoNoteURL = baseURL + '/todoNote'
export const todoAttachmentsURL = baseURL + '/todoAttachments'
...
export const meetingSummaryURL = baseURL + '/meetingSummary'
