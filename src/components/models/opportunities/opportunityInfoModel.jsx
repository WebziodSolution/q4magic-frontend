...
function OpportunityInfoModel({ open, handleClose, opportunityId, setSyncingPushStatus }) {
    ...
    }, [open, opportunityId, isEditingWhy, isEditingCurrentEnv, isEditingValue,
    ...
    const startEditField = (field) => {
        ...
        if (hasUnsavedChangesInField(currentlyEditingField)) {
            ...
            setUnsavedChangesDialog({
                ...
                open: true,
                title: "Unsaved Changes",
                message: `You have unsaved changes. Do you want to save before editing another field?`,
                actionButtonText: "Save",
                cancelButtonText: "Don't Save",
            ...
            >
                <Components.DialogTitle sx={{ m: 0, p: 2, color: theme.palette.text.primary }} id="customized-dialog-title">
                    ...
                    <div className='flex justify-start items-center gap-3'>
                        ...
                        <span className="text-lg font-bold text-gray-800 grow">
                            {watch("accountName")}
                        </span>
                    </div>
                ...
                <Components.DialogContent dividers>
                    ...
                    {selectedTab === 0 && (
                        <div className="flex-1 px-4 py-3 overflow-y-auto overflow-x-auto">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 min-w-[360px]">
                                ...
                                <div className="border border-gray-200 p-3 rounded-md flex flex-col cursor-pointer">
                                    <div className="flex justify-between items-center mb-2">
                                        <h3 className="text-base font-semibold text-gray-800">
                                            Decision Map
                                        </h3>
                    ...
                    {/* MEDDIC VIEW */}
                    {selectedTab === 1 && (
                        <div className="flex-1 overflow-y-auto p-4 bg-[rgb(224,239,251)] mt-3">
                                ...
                                <>
                                    {saveButton && (
                                        ((selectedType === "Opp360" && isAnyOpp360Editing) ||
                                            ...
                                            <Button type={`button`} onClick={handleSaveAllOpp360} text={"Submit"} endIcon={<CustomIcons iconName={'fa-solid fa-floppy-disk'} css='cursor-pointer' />} />
                                        )
                                    )}
                                </>
                            )}
                        <Button type="button" text={"Cancel"} useFor='disabled' onClick={() => handleCancelWithUnsavedCheck()} startIcon={<CustomIcons iconName={'fa-solid fa-xmark'} css='cursor-pointer mr-2' />} />
                    </div>
                </Components.DialogActions>
